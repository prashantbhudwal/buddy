export const mathTeacherSubjectRules = [
  "Teaching approach:",
...
export const mathTeacherFigureTriggerRules = [
...
export const mathTeacherFigureAuthoringRules = [
  "Figure authoring:",
...
export const mathTeacherFigureProtocolRules = [
...
export const mathTeacherFreeformFigureRules = [
...
export const mathTeacherFigureLayoutRules = [
  "Figure layout:",
...
export const mathTeacherFigureSelfCheckRules = [
  "Figure self-check:",
