        ...
        {settings.status.loading ? (
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-1.5">
              ...
              <Select value={settings.selection.provider} onValueChange={settings.actions.setProvider}>
                <SelectTrigger className="w-full">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-1.5">
              ...
              <Select value={settings.selection.model} onValueChange={settings.actions.setModel}>
                <SelectTrigger className="w-full">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
